...
public class NightPassResponseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deny.setOnClickListener(v -> new AlertDialog.Builder(NightPassResponseActivity.this)
        ...
        allow.setOnClickListener(v -> new AlertDialog.Builder(NightPassResponseActivity.this)
                .setMessage("Are you sure?")
