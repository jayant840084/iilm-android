...
public class OutPassAttributes {
    ...
    public static final String PHONE_NUMBER_VISITING = "phoneNumberVisiting";
    public static final String BRANCH = "branch";
    public static final String YEAR = "year";
    public static final String OUT_PASS_TYPE = "outpassType";
    public static final String ROOM_NUMBER = "roomNumber";
    public static final String DATE_LEAVE = "dateLeave";
